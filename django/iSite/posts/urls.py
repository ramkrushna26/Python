...
from . import views
from .views import PostListView, postCreate, postUpdate, PostDetailView, PostDeleteView, UserPostsView, addComment, approveComment, deleteComment
...
urlpatterns = [
    ...
    path('comment/<int:pk>/', approveComment, name='approve-comment'),
